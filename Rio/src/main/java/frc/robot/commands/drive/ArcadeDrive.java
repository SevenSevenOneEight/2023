...
public class ArcadeDrive extends CommandBase {
    ...
    public ArcadeDrive(DifferentialDriveSuper drive, CommandXboxController driverController) {
        this.difDrive = drive;
    ...
    @Override
    public void execute() {
        difDrive.drive.arcadeDrive(-pilotController.getLeftY(), -pilotController.getRightX(), true);
    }
}