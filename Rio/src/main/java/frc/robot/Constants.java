...
public final class Constants {
    ...
    public static class DriveConstants {
        // Spark Max Setup
        public static final int k_leftFrontID = 0;
        public static final int k_leftBackID = 1;
        public static final int k_rightFrontID = 2;
        public static final int k_rightBackID = 3;
